#!/usr/bin/env bash
# m8_fullcycle_30mm_capture.sh — M8: ONE controlled FULL pick-and-place cycle
...
#     5. output prefix m8_fullcycle_30mm_* so NOTHING overwrites the
...
LOGDIR="docs"
SIM_LOG="${LOGDIR}/m8_fullcycle_30mm_sim_${TS}.log"
MG_LOG="${LOGDIR}/m8_fullcycle_30mm_movegroup_${TS}.log"
GRASP_LOG="${LOGDIR}/m8_fullcycle_30mm_grasp_${TS}.log"
STALL_CSV="${LOGDIR}/m8_fullcycle_30mm_stalls_${TS}.csv"
STALL_LOG="${LOGDIR}/m8_fullcycle_30mm_stallmonitor_${TS}.log"
TRAJ_CSV="runs/m8_fullcycle_30mm_traj_${TS}.csv"
TRAJ_LOG="${LOGDIR}/m8_fullcycle_30mm_trajrecorder_${TS}.log"
CONTACT_L="${LOGDIR}/m8_fullcycle_30mm_contact_left_${TS}.log"
CONTACT_R="${LOGDIR}/m8_fullcycle_30mm_contact_right_${TS}.log"
POSE_CSV="runs/m8_fullcycle_30mm_pose_${TS}.csv"
POSE_LOG="${LOGDIR}/m8_fullcycle_30mm_poserecorder_${TS}.log"
MARKER_DIR="${LOGDIR}/m8_fullcycle_30mm_markers_${TS}"
CSV_PATH="m3_grasp_trace_m8_fullcycle_30mm_${TS}.csv"
