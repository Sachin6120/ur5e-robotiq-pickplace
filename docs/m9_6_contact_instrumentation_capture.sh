#!/usr/bin/env bash
# m9_6_contact_instrumentation_capture.sh — M9.6: ONE diagnostic full pick-and-place cycle,
# WORLD-X CONTACT/CONSTRAINT INSTRUMENTATION (2026-08-22).
#
...
#     5. output prefix m9_6_contact_instrumentation_* so NOTHING overwrites the
...
LOGDIR="docs"
SIM_LOG="${LOGDIR}/m9_6_contact_instrumentation_sim_${TS}.log"
MG_LOG="${LOGDIR}/m9_6_contact_instrumentation_movegroup_${TS}.log"
GRASP_LOG="${LOGDIR}/m9_6_contact_instrumentation_grasp_${TS}.log"
STALL_CSV="${LOGDIR}/m9_6_contact_instrumentation_stalls_${TS}.csv"
STALL_LOG="${LOGDIR}/m9_6_contact_instrumentation_stallmonitor_${TS}.log"
TRAJ_CSV="runs/m9_6_contact_instrumentation_traj_${TS}.csv"
TRAJ_LOG="${LOGDIR}/m9_6_contact_instrumentation_trajrecorder_${TS}.log"
CONTACT_L="${LOGDIR}/m9_6_contact_instrumentation_contact_left_${TS}.log"
CONTACT_R="${LOGDIR}/m9_6_contact_instrumentation_contact_right_${TS}.log"
POSE_CSV="runs/m9_6_contact_instrumentation_pose_${TS}.csv"
POSE_LOG="${LOGDIR}/m9_6_contact_instrumentation_poserecorder_${TS}.log"
MARKER_DIR="${LOGDIR}/m9_6_contact_instrumentation_markers_${TS}"
CSV_PATH="m3_grasp_trace_m9_6_contact_instrumentation_${TS}.csv"
