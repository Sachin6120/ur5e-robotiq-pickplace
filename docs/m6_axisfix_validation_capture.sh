#!/usr/bin/env bash
# m6_axisfix_validation_capture.sh — ONE controlled validation run of the M6
# closing-axis fix (2026-08-21).
#
# WHAT THIS VALIDATES
...
#     3. output prefix m6_axisfix_* so NOTHING overwrites the historical
#        m6_30mm_* / m6_baseline_* evidence.
...
LOGDIR="docs"
SIM_LOG="${LOGDIR}/m6_axisfix_sim_${TS}.log"
MG_LOG="${LOGDIR}/m6_axisfix_movegroup_${TS}.log"
GRASP_LOG="${LOGDIR}/m6_axisfix_grasp_${TS}.log"
STALL_CSV="${LOGDIR}/m6_axisfix_stalls_${TS}.csv"
STALL_LOG="${LOGDIR}/m6_axisfix_stallmonitor_${TS}.log"
TRAJ_CSV="runs/m6_axisfix_traj_${TS}.csv"
TRAJ_LOG="${LOGDIR}/m6_axisfix_trajrecorder_${TS}.log"
CONTACT_L="${LOGDIR}/m6_axisfix_contact_left_${TS}.log"
CONTACT_R="${LOGDIR}/m6_axisfix_contact_right_${TS}.log"
CSV_PATH="m3_grasp_trace_m6_axisfix_${TS}.csv"
