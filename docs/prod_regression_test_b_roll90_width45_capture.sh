#!/usr/bin/env bash
# prod_reg_test_b_roll90_width45_capture.sh — TEST B: Production regression test (45mm, roll 90),
# PRODUCTION REGRESSION TEST B: 45MM ROLL 90 (2026-08-22).
#
...
#     5. output prefix prod_reg_test_b_roll90_width45_* so NOTHING overwrites the
...
LOGDIR="docs"
SIM_LOG="${LOGDIR}/prod_reg_test_b_roll90_width45_sim_${TS}.log"
MG_LOG="${LOGDIR}/prod_reg_test_b_roll90_width45_movegroup_${TS}.log"
GRASP_LOG="${LOGDIR}/prod_reg_test_b_roll90_width45_grasp_${TS}.log"
STALL_CSV="${LOGDIR}/prod_reg_test_b_roll90_width45_stalls_${TS}.csv"
STALL_LOG="${LOGDIR}/prod_reg_test_b_roll90_width45_stallmonitor_${TS}.log"
TRAJ_CSV="runs/prod_reg_test_b_roll90_width45_traj_${TS}.csv"
TRAJ_LOG="${LOGDIR}/prod_reg_test_b_roll90_width45_trajrecorder_${TS}.log"
CONTACT_L="${LOGDIR}/prod_reg_test_b_roll90_width45_contact_left_${TS}.log"
CONTACT_R="${LOGDIR}/prod_reg_test_b_roll90_width45_contact_right_${TS}.log"
POSE_CSV="runs/prod_reg_test_b_roll90_width45_pose_${TS}.csv"
POSE_LOG="${LOGDIR}/prod_reg_test_b_roll90_width45_poserecorder_${TS}.log"
MARKER_DIR="${LOGDIR}/prod_reg_test_b_roll90_width45_markers_${TS}"
CSV_PATH="m3_grasp_trace_prod_reg_test_b_roll90_width45_${TS}.csv"
