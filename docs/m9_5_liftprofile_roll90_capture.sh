#!/usr/bin/env bash
# m9_5_liftprofile_roll90_capture.sh — M9.5: ONE full pick-and-place cycle,
# CONTROLLED LIFT ACCELERATION TEST (2026-08-22).
#
...
#     5. output prefix m9_5_liftprofile_roll90_* so NOTHING overwrites the
...
LOGDIR="docs"
SIM_LOG="${LOGDIR}/m9_5_liftprofile_roll90_sim_${TS}.log"
MG_LOG="${LOGDIR}/m9_5_liftprofile_roll90_movegroup_${TS}.log"
GRASP_LOG="${LOGDIR}/m9_5_liftprofile_roll90_grasp_${TS}.log"
STALL_CSV="${LOGDIR}/m9_5_liftprofile_roll90_stalls_${TS}.csv"
STALL_LOG="${LOGDIR}/m9_5_liftprofile_roll90_stallmonitor_${TS}.log"
TRAJ_CSV="runs/m9_5_liftprofile_roll90_traj_${TS}.csv"
TRAJ_LOG="${LOGDIR}/m9_5_liftprofile_roll90_trajrecorder_${TS}.log"
CONTACT_L="${LOGDIR}/m9_5_liftprofile_roll90_contact_left_${TS}.log"
CONTACT_R="${LOGDIR}/m9_5_liftprofile_roll90_contact_right_${TS}.log"
POSE_CSV="runs/m9_5_liftprofile_roll90_pose_${TS}.csv"
POSE_LOG="${LOGDIR}/m9_5_liftprofile_roll90_poserecorder_${TS}.log"
MARKER_DIR="${LOGDIR}/m9_5_liftprofile_roll90_markers_${TS}"
CSV_PATH="m3_grasp_trace_m9_5_liftprofile_roll90_${TS}.csv"
