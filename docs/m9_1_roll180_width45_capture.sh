#!/usr/bin/env bash
# m9_1_roll180_width45_capture.sh — M9.1: ONE full pick-and-place cycle,
...
#     5. output prefix m9_1_roll180_width45_* so NOTHING overwrites the
...
LOGDIR="docs"
SIM_LOG="${LOGDIR}/m9_1_roll180_width45_sim_${TS}.log"
MG_LOG="${LOGDIR}/m9_1_roll180_width45_movegroup_${TS}.log"
GRASP_LOG="${LOGDIR}/m9_1_roll180_width45_grasp_${TS}.log"
STALL_CSV="${LOGDIR}/m9_1_roll180_width45_stalls_${TS}.csv"
STALL_LOG="${LOGDIR}/m9_1_roll180_width45_stallmonitor_${TS}.log"
TRAJ_CSV="runs/m9_1_roll180_width45_traj_${TS}.csv"
TRAJ_LOG="${LOGDIR}/m9_1_roll180_width45_trajrecorder_${TS}.log"
CONTACT_L="${LOGDIR}/m9_1_roll180_width45_contact_left_${TS}.log"
CONTACT_R="${LOGDIR}/m9_1_roll180_width45_contact_right_${TS}.log"
POSE_CSV="runs/m9_1_roll180_width45_pose_${TS}.csv"
POSE_LOG="${LOGDIR}/m9_1_roll180_width45_poserecorder_${TS}.log"
MARKER_DIR="${LOGDIR}/m9_1_roll180_width45_markers_${TS}"
CSV_PATH="m3_grasp_trace_m9_1_roll180_width45_${TS}.csv"
