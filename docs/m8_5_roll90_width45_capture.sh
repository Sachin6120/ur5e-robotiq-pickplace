#!/usr/bin/env bash
# m8_5_roll90_width45_capture.sh — M8.5: ONE full pick-and-place cycle,
# ROLL/WIDTH CONFOUND-BREAKER (2026-08-22).
#
...
#     5. output prefix m8_5_roll90_width45_* so NOTHING overwrites the
...
LOGDIR="docs"
SIM_LOG="${LOGDIR}/m8_5_roll90_width45_sim_${TS}.log"
MG_LOG="${LOGDIR}/m8_5_roll90_width45_movegroup_${TS}.log"
GRASP_LOG="${LOGDIR}/m8_5_roll90_width45_grasp_${TS}.log"
STALL_CSV="${LOGDIR}/m8_5_roll90_width45_stalls_${TS}.csv"
STALL_LOG="${LOGDIR}/m8_5_roll90_width45_stallmonitor_${TS}.log"
TRAJ_CSV="runs/m8_5_roll90_width45_traj_${TS}.csv"
TRAJ_LOG="${LOGDIR}/m8_5_roll90_width45_trajrecorder_${TS}.log"
CONTACT_L="${LOGDIR}/m8_5_roll90_width45_contact_left_${TS}.log"
CONTACT_R="${LOGDIR}/m8_5_roll90_width45_contact_right_${TS}.log"
POSE_CSV="runs/m8_5_roll90_width45_pose_${TS}.csv"
POSE_LOG="${LOGDIR}/m8_5_roll90_width45_poserecorder_${TS}.log"
MARKER_DIR="${LOGDIR}/m8_5_roll90_width45_markers_${TS}"
CSV_PATH="m3_grasp_trace_m8_5_roll90_width45_${TS}.csv"
